...
class EnrollmentViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return Enrollment.objects.filter(user=user).select_related('user', 'package', 'payment').prefetch_related('add_ons')
    ...
    def user_enrollments(self, request):
        enrollments = Enrollment.objects.filter(user=request.user).select_related('package', 'payment').prefetch_related('add_ons')
